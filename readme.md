...
- **m8ax_pi_engine.cpp:** Motor principal basado en la arquitectura **Mini-Pi de Alexander J. Yee**.
...
- **Gestión de Memoria:** Algoritmos de control que monitorizan la RAM disponible antes de iniciar cálculos de gran envergadura.
...
- **m8ax_pi_engine.cpp:** Core engine based on the **Mini-Pi architecture by Alexander J. Yee**.
